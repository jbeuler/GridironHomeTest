...
export class ApplicationService {
  ...
  putApplication() {
    return this.http.put(`${environment.apiBaseUrl}/Applications/${this.formData.id}`, this.formData);
  }

  deleteApplication(applicationId:number) {
    return this.http.delete(`${environment.apiBaseUrl}/Applications/${applicationId}`);
  }
